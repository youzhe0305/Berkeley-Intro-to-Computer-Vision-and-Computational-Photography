...
if __name__ == '__main__':
    ...
    pts1 = np.load('img_corr_point/desk_high_quality/1.npy')
    pts2 = np.load('img_corr_point/desk_high_quality/2.npy')  
    # print(pts1)
    # print(pts2)
    # H = compute_H(pts1, pts2)
    # print(H)
    ...
    img1 = cv2.imread('desk_high_quality/1.jpg', cv2.IMREAD_COLOR)
    img2 = cv2.imread('desk_high_quality/2.jpg', cv2.IMREAD_COLOR)
